    ...
    <Stack spacing={0.5}>
      ...
      >
        <ColorSchemeScope
          mode={mode}
          sx={[
            { position: 'relative', px: 1.5, py: 1.5, textAlign: 'center' },
            pageFontSx(option.key),
          ]}
        >
...
// (`system` plus the self-hosted faces in src/lib/pageFonts.js). Adding a font is
...
export default function FontPicker({ value, mode, onChange }) {
  return (
