...
// same scope + stack the live public page uses (content card included), so the
// preview can't drift from the content visitors see; it deliberately omits the
// page's surrounding chrome (share button, privacy footer, viewport spacing,
// click tracking). Its
