...
// The Preview tab body: renders the public page's content (the WidgetStack)
// inside a framed ColorSchemeScope forced to the band's chosen scheme. It's the
// same scope + stack the live public page uses, so the preview can't drift from
// the content visitors see; it deliberately omits the page's surrounding chrome
// (floating share button, privacy footer, viewport spacing, click tracking). Its
