...
// it can be unit-tested and reused. Widget *rendering* lives in WidgetStack,
// *editing* in WidgetEditors, and *validation* server-side in layout.js — this
// module is the shared client vocabulary between the editor's controls.
