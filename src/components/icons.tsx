...
// the brand colour.
export function SpotifyIcon({ size, mono = false }: IconProps) {
  return (
...
export const PLATFORM_ICON_COMPONENTS: Record<string, IconComponent> = {
...
export const LINK_ICON_COMPONENTS: Record<string, IconComponent> = Object.fromEntries(
